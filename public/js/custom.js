...
function init_BookingOne() {
	...
	//6. Choose variant proccess
                ...
                //choose time
                $(document).delegate('.time-select__item',"click",function (e){
                	//visual iteractive for choose
...
function init_BookingTwo () {
    ...
    //3. Choose sits (and count price for them)
                ...
                $('.sits__place').click(function (e) {
                    ...
                    //data element init
                    var number = $('.web-checked-place').children().length;
        ...
        function ChoosePlace (e) {
                ...
                if ( $('.mobile-checked-place').find(".mobile-choosen-place[data-sit='"+ch_sits+"']").length ) {
                    alert('same place');
                    return 0;
                }
                ...
                $(this).click( function (e){
                    ...
                    var activeSit = $('.mobile-checked-place').find(".choosen-place[data-sit='"+ch_sits+"']");
	...
	//1. Dropdown init 
                ...
                $(".select__sort").selectbox({
                    onChange: function (val, inst) {
                        ...
                        //set form(sortingByParams) elements
                        $('#genreParam').val($('select[name="genre"] option:selected').val());
                        $('#orderParam').val($('ul').find('li a.item-active').attr('data-filter'));
